...
cdef class RadiationBase:
    ...
    cpdef initialize_profiles(self, Grid.Grid Gr, ReferenceState.ReferenceState RS, Th, DiagnosticVariables.DiagnosticVariables DV,
        ...
        with nogil:
           for ip in xrange(n_pencils):
               ...
               for k in xrange(nz):
                   ...
                   heating_rate_clear_pencil[ip, k] = (hrc_lw_out[ip,k] + hrc_sw_out[ip,k]) * RS.rho0_half_global[k+gw] * cpm_c(qv_pencil[ip,k])/86400.0
...
cdef class RadiationTRMM_LBA(RadiationBase):
    ...
    cpdef update(self, Grid.Grid Gr, ReferenceState.ReferenceState RS,
        ...
        # to fix teh fluxes at max values use this
        #elif TS.t>18900.0:
        #    for kk in range(0,Gr.dims.nlg[2]):
